      ...
      <div className="w-full max-w-sm animate-fade-up">
        ...
        <div className="panel mt-8 space-y-4 p-6">
          <input
            ...
            autoFocus
            className="w-full rounded-xl border border-slate-400/15 bg-ink-950/70 px-4 py-3 text-slate-100 placeholder:text-slate-600 focus:border-sky-400/50 focus:outline-none focus:ring-2 focus:ring-sky-400/20"
          />
          <button
            type="button"
            onClick={submit}
